...
#include "Untitled_race_gamePlayerController.generated.h"

class UInputMappingContext;
class AUntitled_race_gamePawn;
class UUntitled_race_gameUI;
 ...
 */
UCLASS(abstract)
class UNTITLED_RACE_GAME_API AUntitled_race_gamePlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TObjectPtr<AUntitled_race_gamePawn> VehiclePawn;

	/** Type of the UI to spawn */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = UI)
	TSubclassOf<UUntitled_race_gameUI> VehicleUIClass;

	/** Pointer to the UI widget */
	TObjectPtr<UUntitled_race_gameUI> VehicleUI;
