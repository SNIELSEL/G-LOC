...
#include "Untitled_race_gameSportsCar.h"
#include "Untitled_race_gameSportsWheelFront.h"
#include "Untitled_race_gameSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AUntitled_race_gameSportsCar::AUntitled_race_gameSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UUntitled_race_gameSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UUntitled_race_gameSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UUntitled_race_gameSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UUntitled_race_gameSportsWheelRear::StaticClass();
