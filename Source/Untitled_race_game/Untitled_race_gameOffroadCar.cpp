...
#include "Untitled_race_gameOffroadCar.h"
#include "Untitled_race_gameOffroadWheelFront.h"
#include "Untitled_race_gameOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

AUntitled_race_gameOffroadCar::AUntitled_race_gameOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UUntitled_race_gameOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UUntitled_race_gameOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UUntitled_race_gameOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UUntitled_race_gameOffroadWheelRear::StaticClass();
